...
list<vertex_t> initializeAdjacencyLists(bool isInside, int sourceNodeId, int destNodeId)
{
    list<vertex_t> path;
	/*****************************************IC MEKAN************************************/
	...
	// 3 = D Z04
	informations::adjacencyListIndoor[3].push_back(neighbour(2, 5)); // Z04-arkaKapi = 2
	informations::adjacencyListIndoor[3].push_back(neighbour(4, 5)); // Z04-Z05 = 4
	// 3 = E Z05
	informations::adjacencyListIndoor[4].push_back(neighbour(3, 5)); // Z05-Z04 = 4
	informations::adjacencyListIndoor[4].push_back(neighbour(5, 5)); // Z05-X1 = 1
	// 3 = F Z05-Z10 arasýndaki köþe X1
	informations::adjacencyListIndoor[5].push_back(neighbour(4, 5)); // X1-Z05 = 1
	informations::adjacencyListIndoor[5].push_back(neighbour(6, 5)); // X1-Z10 = 3
	// 4 = G Z10
	informations::adjacencyListIndoor[6].push_back(neighbour(5, 5)); // Z10-X1 = 3
	informations::adjacencyListIndoor[6].push_back(neighbour(7, 5)); // Z10-X2 = 1
	// 4 = H Z10-Mikro arasi duz köse X2
	informations::adjacencyListIndoor[7].push_back(neighbour(6, 5)); // X2-Z10 = 1
	informations::adjacencyListIndoor[7].push_back(neighbour(8, 5)); // X2-X3 = 2
	// 5 = G Z10-Mikro arasi yan kose X3
	informations::adjacencyListIndoor[8].push_back(neighbour(7, 5)); // X3-X2 = 2
	informations::adjacencyListIndoor[8].push_back(neighbour(9, 5)); // X3-MikroLab = 2
	// 5 = H MikroLab
	informations::adjacencyListIndoor[9].push_back(neighbour(8, 5));  // MikroLab-X3 = 2
	informations::adjacencyListIndoor[9].push_back(neighbour(10, 5)); // MikroLab-WcKiz = 2
	// 10 = z11
	...
	if (isInside) {
        ...
        path = DijkstraGetShortestPathTo(destNodeId, previous);
...
void initializeDirectionMatrixOutdoor(){
	...
	informations::directionMatrixOutdoor[0][1] = 3;
	informations::directionMatrixOutdoor[0][7] = 2;
	informations::directionMatrixOutdoor[0][15] = 1;
	informations::directionMatrixOutdoor[1][0] = 4;
	informations::directionMatrixOutdoor[1][2] = 3;
	informations::directionMatrixOutdoor[2][1] = 4;
	informations::directionMatrixOutdoor[2][3] = 2;
	informations::directionMatrixOutdoor[3][2] = 1;
	informations::directionMatrixOutdoor[3][4] = 2;
	informations::directionMatrixOutdoor[3][5] = 4;
	informations::directionMatrixOutdoor[4][3] = 1;
	informations::directionMatrixOutdoor[4][5] = 4;
	informations::directionMatrixOutdoor[5][4] = 3;
	informations::directionMatrixOutdoor[5][6] = 4;
	informations::directionMatrixOutdoor[6][5] = 3;
	informations::directionMatrixOutdoor[6][7] = 1;
	informations::directionMatrixOutdoor[7][0] = 1;
	informations::directionMatrixOutdoor[7][6] = 2;
	informations::directionMatrixOutdoor[8][9] = 3;
	informations::directionMatrixOutdoor[8][2] = 4;
	informations::directionMatrixOutdoor[9][8] = 4;
	informations::directionMatrixOutdoor[9][10] = 1;
	informations::directionMatrixOutdoor[10][11] = 1;
	informations::directionMatrixOutdoor[10][9] = 2;
	informations::directionMatrixOutdoor[11][10] = 2;
	informations::directionMatrixOutdoor[11][12] = 3;
	informations::directionMatrixOutdoor[11][17] = 4;
	informations::directionMatrixOutdoor[12][11] = 4;
	informations::directionMatrixOutdoor[12][13] = 3;
	informations::directionMatrixOutdoor[13][12] = 4;
	informations::directionMatrixOutdoor[13][14] = 3;
	informations::directionMatrixOutdoor[14][13] = 4;
	informations::directionMatrixOutdoor[15][0] = 2;
	informations::directionMatrixOutdoor[15][16] = 1;
	informations::directionMatrixOutdoor[16][15] = 2;
	informations::directionMatrixOutdoor[16][17] = 3;
	informations::directionMatrixOutdoor[16][18] = 1;
	informations::directionMatrixOutdoor[17][11] = 3;
	informations::directionMatrixOutdoor[17][16] = 4;
	informations::directionMatrixOutdoor[18][16] = 2;
	informations::directionMatrixOutdoor[18][19] = 1;
	informations::directionMatrixOutdoor[19][18] = 2;
