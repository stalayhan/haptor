...
void mapDisplay::addMarkerButtonsInside(){
	...
	// Z01 - Robotic Lab
	insideButtons.push_back(markerButton(vector3df(-50,5,80), device, 0));
	// Z06
	insideButtons.push_back(markerButton(vector3df(-55,5,58), device, 0));
	// Z11
	insideButtons.push_back(markerButton(vector3df(-45,5,33), device, 10));
	// Z15 - Men WC
	//insideButtons.push_back(markerButton(vector3df(-35,5,13), device, 18));
	// Exit 2
	//insideButtons.push_back(markerButton(vector3df(-90,5,0), device, 17));
	// Z19 - Computer Lab
